...
const {registerchain,registercontract,getchain,getfunction,activeinvocation,activesync,subcontract
...
//  首先校验数据是否正确，校验签名
  ...
  var parse = JSON.parse(res.data);
  ethws.eth.abi.encode('bytes',ethws.eth.abi.encodeParameter())
