...
class Web3jService extends ServiceBase {
    ...
    async getNodeInfo() {
        return this._constructRequest('getNodeInfo', [this.config.groupID]);
    }
    ...
    async getTransactionByHashWithProof(transactionHash) {
        check(arguments, Str);
        return this._constructRequest('getTransactionByHashWithProof', [this.config.groupID, transactionHash]);
    }
