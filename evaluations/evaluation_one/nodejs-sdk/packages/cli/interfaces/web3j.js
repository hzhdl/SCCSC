...
interfaces.push(produceSubCommandInfo({
        name: 'getNodeInfo',
        describe: 'Query nodeInfo'
    },
    () => {
        return web3jService.getNodeInfo();
    }
));
...
interfaces.push(produceSubCommandInfo({
        name: 'getTransactionByHashWithProof',
        describe: 'Query information about a transaction requested by transaction hash with merkle proof',
        args: [{
            name: 'transactionHash',
            options: {
                type: 'string',
    ...
    (argv) => {
        let transactionHash = argv.transactionHash;
        return web3jService.getTransactionByHashWithProof(transactionHash);
    }
));
