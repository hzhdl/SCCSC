...
const { registerEventLogCallback, unregisterEventLogCallback , getsocketstatus } = require('../common/network');
...
class EventLogService extends ServiceBase {
    ...
    async registerEventLogFilter(
        ...
        // console.log(node)
        return registerEventLogCallback(requestData, callback, node, this.config.authentication, this.config.timeout,true);
    }
