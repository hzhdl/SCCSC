...
const {pub,newpub,SetOC,fiscopub}=require("./pub.js")
...
const add="0x11b6d7495f2f04bdca45e9685ceadea4d4bd1832"
...
describe("proxy", function () {
    ...
    async function getdeploycontractinfisco(name) {
        ...
        await contract.$deploy(web3jService).then(async (res)=>{
            console.log(res)
        });
    ...
    describe("test fiscocode",()=>{
        it('regitster contract', async function () {
            const Goldprice = await getdeploycontractinfisco("Goldprice");
            // console.log(deploycontractinfisco)
            // console.log(Goldprice.$getAddress());
            // console.log(Goldprice.$getEventABIOf('SetGoldprice'));
            // console.log(Goldprice.$getFunctionABIOf("getGoldprice"));


            // // 获取信息，进行注册   port,contract,Function,Event,Flag,password
           await fiscopub("3002",Goldprice,"getGoldprice",['SetGoldprice'],'0',"123456").then((data)=>{
