...
const GetContractClassWithABI = require('./contractClass').GetContractClassWithABI;
...
class CompileService extends ServiceBase {
    ...
    */
    ...
    /**
    * Create a ContractClass with abi
    * @param {string} abi
    * @param {Object} address
    */
    GetContractClassByABI(name,abi) {
        return GetContractClassWithABI(name,abi,this.config.encryptType)
    }
